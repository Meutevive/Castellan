...
<body style="background-color:whitesmoke;">
    ...
    <div id="infos">
        ...
        <br><br><br>
        <div id="suivi">
            <h3> Véhicule disponible </h3>
                
                <table>
                    <tr><th>Type</th><th>Marque</th><th>Modèle</th><th>Transmission</th><th>Immatriculation</th></tr>
                    <?php
                    $id = mysqli_connect("172.20.111.124","abass", "abass", "autoecole");//connexion au serveur mysql
                    mysqli_query($id,"SET NAMES 'utf8'");
                    $request = "SELECT * FROM vehicule WHERE etat like 'Disponible'";
                    $response = mysqli_query($id,$request);
                    while($ligne=mysqli_fetch_assoc($response)){
                        echo
                        "<tr><td>".$ligne['type']."</td>
                        <td>".$ligne['marque']."</td>
                        <td>".$ligne['modele']."</td>
                        <td>".$ligne['transmission']."</td>
                        <td>".$ligne['immatriculation']."</td></tr>";
                    }
                    ?>
                </table>
    ...
    <div id="plan">
        ...
        <div id="agenda">
        <table>
            <tr><th> lun. </th><th> mard. </th><th> mer. </th><th> jeu. </th><th> ven. </th></tr>
            <?php
            $id = mysqli_connect("172.20.111.124","abass", "abass", "autoecole");//connexion au serveur mysql
            mysqli_query($id,"SET NAMES 'utf8'");
            ...
            <?php while($ligne1 = mysqli_fetch_assoc($reponse1) 
